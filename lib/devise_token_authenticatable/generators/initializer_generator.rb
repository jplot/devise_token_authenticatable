...
module DeviseTokenAuthenticatable
  class InitializerGenerator < Rails::Generators::Base
    ...
    ## Ecriture ApplicationController

    def append_application_controller
      inject_into_file "app/controllers/application_controller.rb", "include Devise::Controllers::TokenAuthenticatable\n", after: ("class ApplicationController < ActionController::Base\n" || "class ApplicationController < ActionController::API\n")
    end
